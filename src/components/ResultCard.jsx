...
function RiskMeter({ risk, confidence }) {
  const isHigh = risk === 'High Risk';
  const percentage = confidence || (isHigh ? 82 : 18);
...
export default function ResultCard({ result, onReset, confidence }) {
  ...
  return (
    <motion.div key="result"
      ...
      <div className="mb-5"><RiskMeter risk={result} confidence={confidence} /></div>
