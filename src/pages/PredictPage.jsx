  ...
  },
  {
    ...
    fields: [
      ...
      { 
        ...
        icon: Activity, 
        options: [
          { value: '0', label: 'Non-drinker' }, 
          { value: '1', label: 'Drinker' }
        ] 
      },
    ],
  },
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="font-dm-mono text-[10px] text-slate-500 tracking-wider">8 biomarkers required</p>
                    </div>
                  </div>
                  <div className="flex flex-col items-end gap-1.5">
                    <span className="font-dm-mono text-[10px] text-cyan-400/60">{filledCount}/8</span>
